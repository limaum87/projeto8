 ...
 * @author felipe
 */
public class MultiplosChamados {
    Connection conexao;
...
public MultiplosChamados(Fechamento fs) throws IOException{

    conexao = new ConnectionFactory().getConnection();
    inputStream = getClass().getResourceAsStream( "MultiChamados.jasper" );
    ...
    try {
        relatorioutil.abrirRelatorio( "MultiplosChamados", inputStream, parametros, conexao );
