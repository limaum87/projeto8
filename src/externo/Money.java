...
public final class Money implements Comparable<Money>, Serializable {
  ...
  */
  ...
  public Money times2(double aFactor){
    BigDecimal newAmount = fAmount.multiply(asBigDecimal(aFactor));
    newAmount = newAmount.round(new MathContext(4, RoundingMode.HALF_UP));
  ...
  */
  ...
  public String toStringcomSimbolo(){
    return fCurrency.getSymbol() + " " + fAmount.toPlainString();
  }
  public String toStringsemSimbolo(){
    fAmount=fAmount.setScale(2);
